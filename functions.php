...
function countdown_timer() { ?>
	<input type="text" name="countdown" id="countdown" value="<?php echo get_option('countdown'); ?>" />
<?php 
}
...
function media_menu_page_setup() {
    ...
    add_settings_field( 'countdown', 'Countdown Timer', 'countdown_timer', 'theme-options', 'section' );
    register_setting('section', 'twitter');
    register_setting('section', 'facebook');
    register_setting('section', 'instagram');
    register_setting('section', 'linkedin');
    register_setting('section', 'countdown');
}
...
function custom_pagination($numpages = '', $pagerange = '', $paged='') {
    ...
    if ($paginate_links) {
        echo "<div class='custom-pagination'>";
            ...
            echo '<span class="page-num">&nbsp;||&nbsp;</span>';
            echo $paginate_links;
        echo "</div>";
    }
}
add_action( 'wp_loaded', 'custom_pagination' );
